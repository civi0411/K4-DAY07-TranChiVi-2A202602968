...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Matches whitespace following sentence-ending punctuation (. ! ?)
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        for part in parts:
            if len(part) <= self.chunk_size:
                good_pieces.append(part)
            else:
                good_pieces.extend(self._split(part, remaining_separators[1:]))

        # Re-merge small pieces up to chunk_size
        merged: list[str] = []
        current_chunk = ""
